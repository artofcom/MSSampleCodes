...
namespace App
{
    public class DirectorMain : MonoBehaviour
    {
        ...
        [SerializeField] AView SurgeLoadingView;
        [SerializeField] AView SurgeHomeView;
        [SerializeField] AView SurgeAnimationView;
        ...
        private IEnumerator Start()
        {
            ...
            SurgeLoading = new SurgeLoadingMVCSFactory().CreateMVCSScreen(SurgeLoadingView, _context);
            SurgeLoading.Initialize();

            SurgeHome = new SurgeHomeMVCSFactory().CreateMVCSScreen(SurgeHomeView, _context);
            SurgeHome.Initialize();

            SurgeAnimation = new SurgeAnimationMVCSFactory().CreateMVCSScreen(SurgeAnimationView, _context);
